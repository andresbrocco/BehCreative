...
public class Skeleton{
  ...
  public PVector centerOfMassRelativeToFloor; // Center of Mass relative to the floor coordinate system.
 ...
 */
  public void update(KSkeleton kSkeleton){
    ...
    this.calculateDistanceBetweenHands();
 ...
 */
  void calculateDistanceBetweenHands(){
    this.distanceBetweenHands = PVector.dist(this.joints[HAND_LEFT].estimatedPosition, this.joints[HAND_RIGHT].estimatedPosition);
  }
 ...
 */
  void calculateCenterOfMass(){
    ...
    this.centerOfMassRelativeToFloor = this.scene.floor.toFloorCoordinateSystem(this.centerOfMass);
  }
